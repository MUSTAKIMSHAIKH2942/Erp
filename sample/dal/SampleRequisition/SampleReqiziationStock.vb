...
Public Class SampleReqiziationStock
    ...
    Public Shared Function AddSampleReqiziationStock(ByVal paramSampleReqiziationStock As SampleReqiziationStock) As Boolean
        ...
        params(4) = New SqlParameter("@TotalQuantity", DBNull.Value)
        params(5) = New SqlParameter("@BatchNo", DBNull.Value)
        params(6) = New SqlParameter("@RemarkIfYes", DBNull.Value)
        params(7) = New SqlParameter("@RequestForwardedToRnD", DBNull.Value)
        params(8) = New SqlParameter("@ConcernedPersonName", DBNull.Value)
        params(9) = New SqlParameter("@RemarkIfNo", DBNull.Value)
