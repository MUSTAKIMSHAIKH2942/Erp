    ...
    <form id="form1" runat="server">
        <table id="Table1" align="center" class="mainTable7">
            ...
            <tr>
                ...
                <td class="tabledata">
                   <asp:FileUpload ID="FUCoveringLetter" CssClass="upload" runat="server" />
                </td>
            </tr>
            <tr>
                <td class="fieldheaders">
                ...
                <td class="tabledata">
                     <asp:FileUpload ID="FUMSDS" CssClass="upload" runat="server" />
                </td>
            </tr>
            <tr>
                <td class="fieldheaders">
                ...
                <td class="tabledata">
                    <asp:FileUpload ID="FUCOA" CssClass="upload" runat="server" />
                </td>
            </tr>
                  <tr>
