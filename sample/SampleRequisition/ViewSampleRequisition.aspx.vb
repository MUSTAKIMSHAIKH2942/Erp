...
Partial Class SampleRequisition_ViewSampleRequisition
    ...
    Protected Sub dgRmcplRequisition_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles dgRmcplRequisition.ItemDataBound
        If e.Item.ItemType = ListItemType.Item Or e.Item.ItemType = ListItemType.AlternatingItem Then
            ...
            CType(e.Item.FindControl("lnkisavailableinplant"), LinkButton).Attributes.Add("target", "_blank")
            CType(e.Item.FindControl("lnkDepartmentRequisition"), LinkButton).Attributes.Add("target", "_blank")
            CType(e.Item.FindControl("lnkSamplePreparation"), LinkButton).Attributes.Add("target", "_blank")
            CType(e.Item.FindControl("lnkPackingLabellingCOAGatePass"), LinkButton).Attributes.Add("target", "_blank")
            CType(e.Item.FindControl("lnkQA_Verification"), LinkButton).Attributes.Add("target", "_blank")
            CType(e.Item.FindControl("lnkIfDelay"), LinkButton).Attributes.Add("target", "_blank")
            CType(e.Item.FindControl("lnkSampleDispatch"), LinkButton).Attributes.Add("target", "_blank")
            CType(e.Item.FindControl("lnkInformCustomerDispatchDetails"), LinkButton).Attributes.Add("target", "_blank")
            CType(e.Item.FindControl("lnkTrackDispatchUntildelivery"), LinkButton).Attributes.Add("target", "_blank")
            CType(e.Item.FindControl("lnkCustomerSampleReceiptCheck"), LinkButton).Attributes.Add("target", "_blank")
            CType(e.Item.FindControl("lnkCustomerSampleApproval"), LinkButton).Attributes.Add("target", "_blank")
            CType(e.Item.FindControl("lnkReceivingOfPOfromCustomer"), LinkButton).Attributes.Add("target", "_blank")
    ...
    Public Sub MakeLinkButtonUntouchableIfComplete(ByVal lbl As Label, ByVal lnk As LinkButton)
        If lbl IsNot Nothing AndAlso lnk IsNot Nothing Then
            ...
            If Not String.IsNullOrEmpty(lblText) Then
                If lblText.Equals("Complete", StringComparison.OrdinalIgnoreCase) Then
